...
WITH atc_tokens AS (
    SELECT TOKEN FROM VALUES
        ...
        -- added 2026-07-23 from Tim Logan's not-added list (email w/ official roster):
        ('BAPTIST MEMORIAL'), ('INDIANA UNIVERSITY'), ('IU HEALTH'), ('SANFORD'),
        ('SSM HEALTH'), ('SAINT LOUIS UNIVERSITY'), ('UT HEALTH SAN ANTONIO')
    AS t(TOKEN)
),
nonatc AS (
    SELECT
