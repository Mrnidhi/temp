...
**Keep Row** — the piece that makes one sheet work. The date parameters bite only on the
live column; every fixed column passes through untouched.
```
...
- Show the three parameter controls: pCenter, pStart, pEnd.
